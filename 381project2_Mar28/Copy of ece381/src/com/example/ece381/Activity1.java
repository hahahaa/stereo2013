...
public class Activity1 extends Activity {
	...
	public double currentSongPositionInTime;
	public int count;
	public int volume;
	public boolean initialized;
	public ListView listView;
	public View rowView;
	public Toast showPlaying;
	...
	public void onDestroy()
	{
		...
		closeSocket();
		tcp_timer.cancel();
		Log.i("Prog", "onDestroy, timer cancelled");
	...
	public void initializeList(int count) {
		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener() 
		{
			...
			{	
				...
				showPlaying.setText(item.get("Song"));
				showPlaying.show();
	...
	public class SocketConnect extends AsyncTask<Void, Void, Socket> {
		...
		protected void onPostExecute(Socket s) {
			...
			else new SocketSend().execute("02.01.Super MArio.kai.5.64.02.LOL.new artist.4.22.");
		}
	}
...
//							      String ipStr_ = intent.getStringExtra("ipStr+");
								...
								if (initialized == false) 
								{
									...
									String lock = s.substring(1);
									Log.i("Prog", lock);
									String[] ss = lock.split("\\.");
...
//		@Override
//		public boolean setViewValue(View view, Cursor data, int arg2) {
